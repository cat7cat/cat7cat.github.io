...
(function ($) {
	$.fn.albeTimeline = function (json, options) {
		...
		$.each(json, function (index, element) {
			...
			badge.body(fnDateFormat(element.time, settings.formatDate, idioma));
			...
			if (element.footer) {
				var ePanelFooter = $('<div>').addClass('panel-footer').body(element.footer);
		...
		var badge = $('<div>').addClass('badge').body('&nbsp;');
		var ePanel = $('<div>').addClass('panel').append(badge);
